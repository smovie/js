...
(function() {
    ...
    function initStyle() {
        ...
        var s = GM_addStyle("\
            ...
            #exchange_75548 {min-height:20px;max-height:20px;padding: 0;margin: 0;background: none repeat scroll 0% 0% #009AFD;color: #FFF;border: 1px solid #1777B7;box-shadow: 0px 1px 0px rgba(255, 255, 255, 0.3) inset, 0px 1px 1px rgba(100, 100, 100, 0.3);border-radius: 3px;cursor: pointer;opacity:0.9; font-size: 12px;} \
            ...
            #fromlabel_75548 {min-height: 20px;max-height: 20px;border: none;font-size: 12px;} #fromlabel_75548::-moz-focus-inner {border: 0;} \
