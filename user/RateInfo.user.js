...
(function(){
    ...
    var init = ()=> {
        ...
        if (insertPos) {
            if (loc.match(/www\.bilibili\.com\/bangumi\/media\/|\.\d\.com\/dongman|\.wjys\.cc\/vod/)) {
    ...
    function addUnionSearch() {
        var sites = {Douban: 'https://www.douban.com/search?cat=1002&q={keyword}', Age: 'https://www.agedm.org/search?query={keyword}',
                     Bilibili: 'https://search.bilibili.com/bangumi?search_source=5&keyword={keyword}', Mx: 'https://www.mxdm4.com/search/-------------.html?wd={keyword}',
